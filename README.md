...
| 26 | Copilot Studio Real-Time Protection | AI Agent Governance |
| 27 | Entra Agent ID Governance | Secretless AI Identity |
| 28 | AI Gateway in Azure API Management | LLM Gateway Zero Trust |
| 29 | Defender for AI & Foundry Guardrails | Content Safety |
...
| 33 | Azure Arc for Hybrid Servers & Defender | Hybrid Posture |
...
### Domain 04: Security Posture, Threat Protection & SecOps [In Progress (10/12)]
| Lab # | Lab Name | Focus Area |
| :--- | :--- | :--- |
| 38 | Defender CSPM & Attack Paths | Risk/Posture |
| 39 | Compliance & Security Frameworks | NIST/PCI-DSS |
| 40 | Defender Workload Protection | FIM/JIT |
| 41 | Defender Vulnerability Management & EASM | Attack Surface |
| 42 | Sentinel Workspace & Content Hub | SIEM Foundation |
| 43 | Sentinel Data Connectors | Log Ingestion |
| 44 | Sentinel Windows Events & Custom Logs | Log Collection |
| 45 | Sentinel Automation & Playbooks | SOAR |
